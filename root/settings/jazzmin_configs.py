...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "UZB Content",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "UZB Content",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "UZB Content",
    ...
    "welcome_sign": _("Welcome to the UZB Content"),
    ...
    "topmenu_links": [
        ...
        {"name": _("Go back to website"), "url": "https://uzbcontent.com/", "permissions": ["auth.view_user"]},
    ...
    "custom_css": "jazzmin/custom_css/main.css",
    "custom_js": None,
